    ...
    for (let index = 0; index < addressBookList.length; index++) {
        innerHtml = `${innerHtml}
            <tr>
                ...
                <td>
                    <img id="1" onclick="remove(this)" src="file:///C:/Users/Lavanya/Desktop/AddressBookApp/Assests/Icons/download%20(1)%20(1).png" alt="delete">
                    <img id="1" onclick="update(this)" src="file:///C:/Users/Lavanya/Desktop/AddressBookApp/Assests/Icons/download%20(2).png"" alt="edit">
                </td>
            </tr>
        `;
    }
